...
import FavoriteReviews from './components/Reviews/FavoriteReviews';
...
function App() {
    ...
    return (
        <Router>
            <div className="App" style={{width: '100%', overflow: 'hidden'}}><AppBar
                position="static"
                sx={{
                    width: '100%',
                    boxShadow: 2,
            ...
            >
                            ...
                            <>
                                ...
                                >
                                    ...
                                    <MenuItem component={Link} to="/reviews" onClick={handleMenuClose}>My
                                        Reviews</MenuItem>
                                    <MenuItem component={Link} to="/favorites" onClick={handleMenuClose}>My
                                        Favorites</MenuItem>
                ...
                <Container style={{marginTop: '2rem'}}>
                    <Routes>
                        ...
                        <Route
                            path="/favorites"
                            element={user ? <FavoriteReviews/> : <Navigate to="/login"/>}
                        />
                        <Route
